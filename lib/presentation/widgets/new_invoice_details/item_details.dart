...
//                     ),TextButton(
//                       onPressed: () {
//                         // Access the discount value
//                         String discountValue = _discountController.text;
//                         // Implement save functionality here using discountValue
//                         print('Discount Value: $discountValue'); // Example action
...
//                     TextButton(
//                       onPressed: () {
//                         // Access the tax value
//                         String taxName = _taxController.text; // Assuming you want to capture the tax name
//                         // Implement save functionality here using taxName
//                         print('Tax Name: $taxName'); // Example action
//                         Navigator.of(context).pop();
//                       },
//                       child: Text('Save'),
//                     ),
...
//                     TextButton(
//                       onPressed: () {
//                         // Access the shipping amount
//                         String shippingAmount = _shippingController.text;
//                         // Implement save functionality here using shippingAmount
//                         print('Shipping Amount: $shippingAmount'); // Example action
//                         Navigator.of(context).pop();
//                       },
//                       child: Text('Save'),
//                     ),
